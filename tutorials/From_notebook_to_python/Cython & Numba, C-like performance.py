...
get_ipython().run_cell_magic('cython', '', 'cpdef int compute_sum(int a, int b):\n    return a + b\n')
...
get_ipython().run_cell_magic('cython', '', 'cpdef inline int compute_sum_mod(int a, int b):\n    return a + b\n')
